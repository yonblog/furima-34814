...
ActiveRecord::Schema.define(version: 2021_03_17_124205) do
  ...
  create_table "purchasing_managements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_purchasing_managements_on_item_id"
    t.index ["user_id"], name: "index_purchasing_managements_on_user_id"
  end
